...
for epoch in range(10):
    ...
    for i in range(len(file)):
        dataset.extend(file[i]["band"][:])
    print('{} Batch shuffle completed'.format(epoch + 1))
    ...
    try:
        model_mse = keras.models.load_model('model_mse_uni2.h5')
    ...
    try:
        ...
        model_mse.save('model_mse_uni2.h5')
    ...
    model_mse.save('model_mse_uni2.h5')
model_mse.save('model_mse_un2i.h5')
